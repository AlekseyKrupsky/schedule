...
import { teachers as apiUrls } from "../config/api";
import { toast } from "../config/toast";
import { teachers as messages } from "../config/messages";
...
export const storeTeacher = requestData => dispatch => {
...
export const updateTeacher = requestData => dispatch => {
...
export const destroyTeacher = requestData => dispatch => {
